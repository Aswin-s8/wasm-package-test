/* @ts-self-types="./car_rental_wasm.d.ts" */

export function close_checkout() {
    wasm.close_checkout();
}

export function confirm_booking() {
    wasm.confirm_booking();
}
 ...
 */
export function load_preset(preset_key) {
    const ptr0 = passStringToWasm0(preset_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.load_preset(ptr0, len0);
}

export function on_field_input() {
    wasm.on_field_input();
}
 ...
 * @param {Event} event
 */
export function on_search(event) {
    wasm.on_search(event);
}
 ...
 * @param {string} value
 */
export function on_ui_field_input(ui_type, value) {
    const ptr0 = passStringToWasm0(ui_type, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(value, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    wasm.on_ui_field_input(ptr0, len0, ptr1, len1);
}

/**
 * @param {string} value
 */
export function on_ui_font_input(value) {
    const ptr0 = passStringToWasm0(value, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.on_ui_font_input(ptr0, len0);
}

/**
 * @param {number} car_index
 */
export function open_checkout(car_index) {
    wasm.open_checkout(car_index);
}
 ...
 * @param {string} hex
 */
export function set_accent_color(hex) {
    const ptr0 = passStringToWasm0(hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.set_accent_color(ptr0, len0);
}

/**
 * @param {string} text
 */
export function show_toast(text) {
 ...
 * @param {boolean} open
 */
export function toggle_drawer(open) {
    wasm.toggle_drawer(open);
}
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h33e44da0d0f9814e);
            return ret;
        },
    ...
    return {
        __proto__: null,
        "./car_rental_wasm_bg.js": import0,
    };
}

function wasm_bindgen__convert__closures_____invoke__h33e44da0d0f9814e(arg0, arg1) {
    wasm.wasm_bindgen__convert__closures_____invoke__h33e44da0d0f9814e(arg0, arg1);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('car_rental_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
